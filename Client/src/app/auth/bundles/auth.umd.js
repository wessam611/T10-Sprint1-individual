(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/router'), require('@angular/forms'), require('@angular/common/http'), require('@nebular/theme'), require('rxjs/operators/switchMap'), require('rxjs/operators/map'), require('rxjs/observable/of'), require('rxjs/BehaviorSubject'), require('rxjs/operators/filter'), require('rxjs/operators/share'), require('rxjs/operators/delay'), require('rxjs/operators/catchError'), require('rxjs/operators/takeWhile')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/router', '@angular/forms', '@angular/common/http', '@nebular/theme', 'rxjs/operators/switchMap', 'rxjs/operators/map', 'rxjs/observable/of', 'rxjs/BehaviorSubject', 'rxjs/operators/filter', 'rxjs/operators/share', 'rxjs/operators/delay', 'rxjs/operators/catchError', 'rxjs/operators/takeWhile'], factory) :
	(factory((global.nb = global.nb || {}, global.nb.auth = global.nb.auth || {}),global.ng.core,global.ng.common,global.ng.router,global.ng.forms,global.ng.common.http,global.nb.theme,global.Rx.operators,global.Rx.operators,global.Rx.Observable,global.Rx,global.Rx.operators,global.Rx.operators,global.Rx.operators,global.Rx.operators,global.Rx.operators));
}(this, (function (exports,_angular_core,_angular_common,_angular_router,_angular_forms,_angular_common_http,_nebular_theme,rxjs_operators_switchMap,rxjs_operators_map,rxjs_observable_of,rxjs_BehaviorSubject,rxjs_operators_filter,rxjs_operators_share,rxjs_operators_delay,rxjs_operators_catchError,rxjs_operators_takeWhile) { 'use strict';
...
var NbTokenService = /** @class */ (function () {
    ...
    function () {
        return this.token$
            .pipe(rxjs_operators_filter.filter(function (value) { return !!value; }), rxjs_operators_share.share());
    };
    /**
    ...
    function () {
        ...
        return rxjs_observable_of.of(token);
    };
    /**
...
var NbAuthService = /** @class */ (function () {
    ...
    function () {
        return this.getToken()
            .pipe(rxjs_operators_map.map(function (token) { return token.isValid(); }));
    };
    /**
        ...
        return this.getProvider(provider).logout()
            ...
            if (result.isSuccess()) {
                _this.tokenService.clear()
                    .pipe(rxjs_operators_map.map(function () { return result; }));
            }
...
var NbDummyAuthProvider = /** @class */ (function (_super) {
    ...
    NbDummyAuthProvider.prototype.authenticate = function (data) {
        return rxjs_observable_of.of(this.createDummyResult(data))
            .pipe(rxjs_operators_delay.delay(this.getConfigValue('delay')));
    };
...
var NbEmailPassAuthProvider = /** @class */ (function (_super) {
    ...
    NbEmailPassAuthProvider.prototype.authenticate = function (data) {
        ...
        return this.http.request(method, url, { body: data, observe: 'response' })
            ...
            return res;
        }), this.validateToken('login'), rxjs_operators_map.map(function (res) {
    ...
    NbEmailPassAuthProvider.prototype.register = function (data) {
        ...
        return this.http.request(method, url, { body: data, observe: 'response' })
            ...
            return res;
        }), this.validateToken('register'), rxjs_operators_map.map(function (res) {
    ...
    NbEmailPassAuthProvider.prototype.validateToken = function (module) {
        var _this = this;
        return rxjs_operators_map.map(function (res) {
